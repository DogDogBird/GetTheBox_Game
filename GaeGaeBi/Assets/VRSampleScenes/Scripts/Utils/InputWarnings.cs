...
namespace VRStandardAssets.Utils
{
    ...
    public class InputWarnings : MonoBehaviour
    {
        ...
        [SerializeField] private string m_DoubleTapWarningMessage = "마우스를 꾹 누르고 있으면 재시작이 됩니다"; // The message to display when the user uses a double tap when they shouldn't.
        [SerializeField] private bool m_ShowSingleTapWarnings;                          // Whether to show warnings by default when the user taps.
        [SerializeField] private string m_SingleTapWarningMessage = "마우스를 꾹 누르고 있으면 재시작이 됩니다"; // The message to display when the user taps when they shouldn't.
