...
namespace VRStandardAssets.Flyer
{
    ...
    public class FlyerGameController : MonoBehaviour
    {
        ...
        public SimpleSceneManager simpleScene;
        ...
        {
            while (!simpleScene.getStartButtonClicked())
            {
                Debug.Log("sdfsdfbasdkufhgasdjkfhsdakjfd0");
        ...
        private IEnumerator EndPhase ()
        {
            ...
            //simpleScene.setStartButtonClicked(false);
